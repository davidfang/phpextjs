    ...
    class PhpextjsControllerCode extends CCodeModel {
        ...
        public function prepare() {
            ...
            $this->files[] = new CCodeFile(
                    //$this->controllerFile, $this->render($templatePath . '/controller.php')
                    Yii::getPathOfAlias('webroot' . '.' . 'app/controller/' . $this->controller) . '.js', $this->render($templatePath . DIRECTORY_SEPARATOR . 'controller.php')
            );
            /*
              foreach ($this->getActionIDs() as $action) {
              $this->files[] = new CCodeFile(
              $this->getViewFile($action), $this->render($templatePath . '/view.php', array('action' => $action))
              );
              }
             *
             */
