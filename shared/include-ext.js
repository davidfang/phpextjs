...
(function() {
    ...
    if (includeCSS) {
        //document.write('<link rel="stylesheet" type="text/css" href="' + path + window.location.pathname + 'resources/css/ext-all' + suffix + '-debug.css"/>');
        document.write('<link rel="stylesheet" type="text/css" href="/resources/css/ext-all' + suffix + '-debug.css"/>');
        //document.write('<link rel="stylesheet" type="text/css" href="' + path + '/sim/resources/css/ext-all'+ suffix + '.css"/>');
    }
    //document.write('<script type="text/javascript" src="' + path + window.location.pathname + 'ext/ext-all-debug' + (rtl ? '-rtl' : '') + '.js"></script>');
    document.write('<script type="text/javascript" src="/ext/ext-all-debug' + (rtl ? '-rtl' : '') + '.js"></script>');
    //document.write('<script type="text/javascript" src="' + path + '/sim/ext/ext-all' + (rtl ? '-rtl' : '') + '.js"></script>');
    ...
    if (neptune) {
        ...
        //neptunePath = (repoDevMode ? path + '/..' : path) + window.location.pathname +
        //    'ext/packages/ext-theme-neptune/build/ext-theme-neptune' +
        //    (repoDevMode ? '-dev' : '') + '.js';
        neptunePath = '/ext/packages/ext-theme-neptune/build/ext-theme-neptune' +
            (repoDevMode ? '-dev' : '') + '.js';
